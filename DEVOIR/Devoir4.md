...
3) Ouvrez un fichier avec vi et practice these actions with VI (Rien à soumettre, mais vous obtenez 4 points pour avoir essayé !). 

- Passez du mode commande au mode insertion. Utilisez les touches fléchées pour vous déplacer. Utilisez 0 et $ pour vous déplacer au début et à la fin d'une ligne.

- Passez en mode commande et déplacez-vous vers une autre ligne en tapant le numéro de ligne après deux-points 

- Supprimez trois lignes

- Retournez en mode insertion. Ajoutez du texte avec votre clavier, puis retournez en mode commande et annulez-le

- Recherchez un texte en utilisant

- Enregistrez votre nouveau fichier et quittez vi


4) Écrivez une boucle while avec vi qui fait ce qui suit : (4 pts)Écrivez une boucle while avec vi qui fait ce qui suit :
